...
// @access  Private/Admin
router.patch('/owner-reports/:id', async (req, res) => {
  try {
    const Report = require('../models/Report');
    ...
    // If status is resolved, mark resolved info
    ...
    await report.populate('owner', 'name email phone businessName');
